...
public class Student extends Person 
{
	...
	{
		return "Student [ Roll Number = " + rollNo + " , Standard = " + std + " , Division = " + division + " , Name = " + name + " , Email Id = " + emailId + " , Phone Number = " + phoneNumber + " , Address = " + address + " , Date Of Birth = " + dob + " ]";
	}
